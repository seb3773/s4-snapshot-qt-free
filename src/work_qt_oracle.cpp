...
WorkQtOracle::WorkQtOracle(Settings *settings, QObject *parent)
    : QObject(parent),
      settings(settings)
{
    if (!settings) {
...
bool WorkQtOracle::isEnvironmentReady() const
{
...
void WorkQtOracle::checkEnoughSpace()
{
...
bool WorkQtOracle::checkInstalled(const QString &package)
{
...
#ifdef UNIT_TESTS
        throw UnitTestExit{EXIT_SUCCESS};
#else
        exit(EXIT_SUCCESS);
#endif
    }
...
bool WorkQtOracle::checkAndMoveWorkDir(const QString &dir, quint64 req_size)
{
...
void WorkQtOracle::checkNoSpaceAndExit(quint64 needed_space, quint64 free_space, const QString &dir)
{
    qDebug() << "+++" << __PRETTY_FUNCTION__ << "+++";
...
bool WorkQtOracle::setupBindRootOverlay()
{
...
void WorkQtOracle::cleanupBindRootOverlay()
{
...
void WorkQtOracle::closeInitrd(const QString &initrd_dir, const QString &file)
{
    qDebug() << "+++" << __PRETTY_FUNCTION__ << "+++";
...
void WorkQtOracle::copyModules(const QString &to, const QString &kernel)
{
...
bool WorkQtOracle::createIso(const QString &filename)
{
    qDebug() << "+++" << __PRETTY_FUNCTION__ << "+++";
...
bool WorkQtOracle::installPackage(const QString &package)
{
...
void WorkQtOracle::makeChecksum(WorkQtOracle::HashType hash_type, const QString &folder, const QString &file_name)
{
    qDebug() << "+++" << __PRETTY_FUNCTION__ << "+++";
...
void WorkQtOracle::openInitrd(const QString &file, const QString &initrd_dir)
{
    qDebug() << "+++" << __PRETTY_FUNCTION__ << "+++";
...
void WorkQtOracle::replaceMenuStrings()
{
    qDebug() << "+++" << __PRETTY_FUNCTION__ << "+++";
...
bool WorkQtOracle::replaceStringInFile(const QString &old_text, const QString &new_text, const QString &file_path)
{
...
void WorkQtOracle::savePackageList(const QString &file_name)
{
    qDebug() << "+++" << __PRETTY_FUNCTION__ << "+++";
...
void WorkQtOracle::writeLsbRelease()
{
...
void WorkQtOracle::writeUnsquashfsSize(const QString &text)
{
...
quint64 WorkQtOracle::getRequiredSpace()
{
