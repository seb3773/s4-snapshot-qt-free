...
# This script is part of S4 Snapshot
#
...
#-----------------------------------------------------------------------
    ...
    #        mk_swap_file=*)     ;;
            ...
            # Other inits only for supported live system currently available within s4-iso-template
            # init=*)
            #    if dpkg --compare-versions "$(dpkg-query -f '${Version}' -W s4-iso-template)" ge "24.03.01mx23"; then
