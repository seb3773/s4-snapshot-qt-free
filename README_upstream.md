...
[![latest packaged version(s)](https://repology.org/badge/latest-versions/s4-snapshot.svg)](https://repology.org/project/s4-snapshot/versions)
[![build result](https://build.opensuse.org/projects/home:mx-packaging/packages/s4-snapshot/badge.svg?type=default)](https://software.opensuse.org//download.html?project=home%3Amx-packaging&package=s4-snapshot)

Program for creating a live-CD from Debian and antiX running system

JUST TO CLARIFY, this program is meant for Debian and antiX it won't work on another other system without considerable modifications because other systems don't have the infrastructure needed to run this program. Don't try to install the deb it won't work and might ruin your system.
